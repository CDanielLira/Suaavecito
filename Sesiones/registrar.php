    ...
    if($_SERVER["REQUEST_METHOD"] == "POST" && $_POST["password1"] == $_POST["password2"]) {
        ...
        try {
            ...
            $mail->Body    = '<h2>¡Bienvenido a Suavecito!</h2>
                              ...
                              <br>
                              <p>A partir de ahora puedes ingresar a cualquier curso y <strong> obtener un certificado </strong> en cualquier lenguaje de programación.</p>
                              <br>
                              <hr>
                              <small>Recibiste este correo porque se introdujo ' . $correo . ' para suscribirse a nuestro sitio, si no fuiste tú, envíanos un mensaje para eliminar tu suscripción </small>';
        ...
        echo "Cuenta registrada correctamente, <a href='ingresar.php'>iniciar sesión</a>";
        ...
        <div class="formulario">
            ...
            <div class="info">
                <form class="row centrar" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                    ...
                    <div class="col-12 py-3 py-3 btn">
